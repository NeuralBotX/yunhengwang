    ...
    >
      <div className="mt-10">
        ...
        <div>
          ...
          <p className="intro-2">
          In this blog, I will share my thoughts on AI, cutting-edge technology, scientific research, and project implementation.
          </p>
          <p className="intro-3">
            ...
            and{" "}
            <a href="https://github.com/Yunheng-Wang" className="link">
              Github account.
            </a>
            <svg
              xmlns="http://www.w3.org/2000/svg"
      ...
      <div className="flex items-center my-4 md:my-6">
        ...
        >
          ...
          <option value="Myanmar">Chinese</option>
        </select>
      </div>
    </section>
  );
